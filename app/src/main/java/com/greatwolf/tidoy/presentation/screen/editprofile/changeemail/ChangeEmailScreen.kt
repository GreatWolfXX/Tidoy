package com.greatwolf.tidoy.presentation.screen.editprofile.changeemail
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = stringResource(id = R.string.title_change_email),
                    fontSize = 18.sp,
            ...
            CustomTextInput(
                ...
                placeholder = R.string.title_email,
                error = emailError,
